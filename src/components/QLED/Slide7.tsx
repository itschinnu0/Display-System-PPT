      ...
      <div className="slide-container flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-6 h-full">
            <div className="col-span-1">
              <div className="advantage-card delay-100 h-full">
                ...
                <h3 className="text-xl font-semibold mb-2">Exceptional Brightness</h3>
                <p className="text-gray-300 mb-3">
                  Premium QLED displays achieve peak brightness levels double that
                  of OLED competitors
                </p>
                <div className="mt-4">
                  ...
                  <div className="comparison-bar">
                    <div className="comparison-fill" style={{ '--fill-width': '100%' } as CSSProperties}></div>
                  </div>
                  ...
                  <div className="comparison-bar">
                    <div className="comparison-fill" style={{ '--fill-width': '60%' } as CSSProperties}></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="px-16 py-4 mb-2">
          <p className="content-subtitle text-sm text-gray-400 text-center">
            QLED technology combines industry-leading brightness with exceptional
            durability and accurate colors
          </p>
        </div>
      </div>
    </section>
